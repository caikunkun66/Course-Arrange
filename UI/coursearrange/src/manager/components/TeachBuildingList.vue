...
export default {
  ...
  methods: {
    ...
    newteachbuild(modifyData) {
      ...
      this.$axios
        .post("/teachbuildinfo/add", modifyData)
        .then(res => {
          if (res.data.code == 0) {
    ...
    modifyTeachBuild(modifyData) {
      this.$axios
        .post("/teachbuildinfo/modify/" + this.editFormData.id, modifyData)
        .then(res => {
          if (res.data.code == 0) {
    ...
    allTeachBuilding() {
      this.$axios
        .get("/teachbuildinfo/list/" + this.page)
        .then(res => {
          if (res.data.code == 0) {
    ...
    deleteTeachBuildingById(id) {
      this.$axios
        .delete("/teachbuildinfo/delete/" + id)
        .then(res => {
          if (res.data.code == 0) {
            this.allTeachBuilding()
